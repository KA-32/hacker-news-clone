...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! isomorphic-fetch */ \"isomorphic-fetch\");\n/* harmony import */ var isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0__);\n\n\nconst getNews = page => {\n  let currentPage = parseInt(page) === 0 || parseInt(page) > 0 ? parseInt(page) : 0;\n  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default()(`https://hn.algolia.com/api/v1/search_by_date?page=${currentPage}&tags=story`).then(res => res.json()).catch(err => err);\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (getNews);\n\n//# sourceURL=webpack:///./src/utils/getNews.js?");
